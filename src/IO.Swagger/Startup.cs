...
namespace IO.Swagger
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //add the service that do main logic (sign it)
            ...
            //sign service that do Authentication of jwt bearer and config it
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                .AddJwtBearer(options =>
                {
                    var jwtSettings = Configuration.GetSection("JwtSettings").Get<JwtSettings>();
                    var key = Encoding.ASCII.GetBytes(jwtSettings.SecretKey); // Retrieve secret key from configuration
                    //select which paramters to validaie in jwt
