...
{
    /// <summary>
    /// class to handle bearer authentication. this class is validate the jwt, if the authentication wiil faild it will return 401
    /// </summary>
    public class BearerAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        /// <summary>
        /// verify that require authorization header exists. this is implempentition of the inherit class 
        /// </summary>
